...
### 13. Gestión de Encuestas (Clínica)
...
│  ─────────────────────────────────────────────────────────────────────     │
│                                                                             │
│  [Todas ▼] [Estado ▼] [Categoría ▼]        🔍 Buscar encuesta...         │
│                                                                             │
│  ┌────────────────────────────────────────────────────────────────────────┐│
│  │ Nombre                        Categoría    Estado      Respuestas  Acción││
│  ├────────────────────────────────────────────────────────────────────────┤│
│  │ Satisfacción Revisión         Calidad     ✅ Activa      85/150   [Ver]││
│  │ Hábitos de Higiene            Prevención  ✅ Activa     120/150   [Ver]││
│  │ Evaluación Dolor              Clínica     ⏸️ Pausada     45/150   [Ver]││
│  │ Cumplimiento Tratamiento      Seguimiento ✅ Activa      92/150   [Ver]││
│  │ Experiencia App Familias      Tecnología  ✅ Activa      68/150   [Ver]││
│  └────────────────────────────────────────────────────────────────────────┘│
│                                                                             │
└─────────────────────────────────────────────────────────────────────────────┘
```
...
### 14. Crear/Editar Encuesta (Clínica)

```
┌─────────────────────────────────────────────────────────────────────────────┐
│ [LOGO] OMI                                    Dr. Juan Pérez  [👤] [⚙️] [🔔] │
├─────────────────────────────────────────────────────────────────────────────┤
│ Nueva Encuesta                                          [Guardar Borrador]  │
├─────────────────────────────────────────────────────────────────────────────┤
│                                                                             │
│  [Información] [Preguntas] [Destinatarios] [Configuración]                 │
│  ═════════════                                                              │
│                                                                             │
│  Información General                                                        │
│  ──────────────────────────────────────────────────────────────────────    │
...
│  Descripción:                                                               │
│  ┌──────────────────────────────────────────────────────────────────────┐  │
│  │ Queremos conocer tu opinión sobre la calidad de atención en tu       │  │
│  │ última revisión para mejorar nuestro servicio.                        │  │
│  └──────────────────────────────────────────────────────────────────────┘  │
│                                                                             │
│  Categoría: [Calidad ▼]    Duración estimada: [5 minutos]                 │
│                                                                             │
│  Preguntas                                                    [+ Añadir]    │
│  ──────────────────────────────────────────────────────────────────────    │
│  ┌──────────────────────────────────────────────────────────────────────┐  │
│  │ 1. ¿Cómo calificarías la atención del personal?    [Editar] [Eliminar]│  │
│  │    Tipo: Escala 1-5 ⭐                                                │  │
│  │    Requerida: ✓                                                        │  │
│  ├──────────────────────────────────────────────────────────────────────┤  │
│  │ 2. ¿El profesional te explicó el tratamiento?     [Editar] [Eliminar]│  │
│  │    Tipo: Sí/No                                                         │  │
│  │    Requerida: ✓                                                        │  │
│  ├──────────────────────────────────────────────────────────────────────┤  │
│  │ 3. Comentarios adicionales                         [Editar] [Eliminar]│  │
│  │    Tipo: Texto libre                                                   │  │
│  │    Requerida: ✗                                                        │  │
│  └──────────────────────────────────────────────────────────────────────┘  │
│                                                                             │
│  [Cancelar]  [Vista Previa]                       [Guardar y Publicar]    │
│                                                                             │
└─────────────────────────────────────────────────────────────────────────────┘
```
...
### 15. Encuestas Disponibles (Familias)
...
### 16. Responder Encuesta (Familias)
...
### 17. Consentimiento Informado y Protección de Datos (Familias)
...
│     de datos                  │
│                               │
│  ☐ Consiento el tratamiento   │
│     de datos de salud del     │
│     menor para su atención    │
│     sanitaria                 │
│                               │
│  ☐ Autorizo el envío de       │
...
### 18. Estado Consentimientos (Clínica)

```
┌─────────────────────────────────────────────────────────────────────────────┐
│ [LOGO] OMI                                    Dr. Juan Pérez  [👤] [⚙️] [🔔] │
├─────────────────────────────────────────────────────────────────────────────┤
│ Ficha Paciente - Carlos Rodríguez                                          │
├─────────────────────────────────────────────────────────────────────────────┤
│                                                                             │
│  [Datos] [Historial] [Plan] [Fotos] [Documentos] [Consentimientos]        │
│                                              ════════════════               │
│                                                                             │
│  Consentimientos Firmados                                                   │
│  ──────────────────────────────────────────────────────────────────────    │
│  ┌────────────────────────────────────────────────────────────────────────┐│
│  │ Documento                        Firmado       Estado      Acción       ││
│  ├────────────────────────────────────────────────────────────────────────┤│
│  │ Protección de Datos RGPD        15/01/2024    ✅ Vigente   [Ver]      ││
│  │ Consentimiento Informado        15/01/2024    ✅ Vigente   [Ver]      ││
│  │ Autorización Tratamiento        15/01/2024    ✅ Vigente   [Ver]      ││
│  │ Comunicaciones                  15/01/2024    ✅ Vigente   [Ver]      ││
│  └────────────────────────────────────────────────────────────────────────┘│
│                                                                             │
│  Pendientes de Firma                                              [Enviar]  │
│  ──────────────────────────────────────────────────────────────────────    │
│  ┌────────────────────────────────────────────────────────────────────────┐│
│  │ ⚠️  Actualización RGPD 2024      Pendiente    [Solicitar Firma]       ││
│  └────────────────────────────────────────────────────────────────────────┘│
│                                                                             │
│  Historial de Cambios                                                       │
│  ──────────────────────────────────────────────────────────────────────    │
│  • 15/01/2024 - Todos los documentos firmados (Ana Rodríguez)             │
│  • 10/01/2024 - Enviado recordatorio                                       │
│  • 05/01/2024 - Primera solicitud enviada                                 │
│                                                                             │
└─────────────────────────────────────────────────────────────────────────────┘
```
